...
7. [취향 유사도 맵](#-취향-유사도-맵-taste-map)
8. [데이터 파이프라인](#-데이터-파이프라인)
9. [기술 스택](#-기술-스택)
10. [아키텍처 / 패키지 구조](#-아키텍처--패키지-구조)
11. [실행 방법](#-실행-방법)
12. [개발 기록 (타임라인)](#️-개발-기록-타임라인)
13. [팀](#-팀)
...
CineMatch의 핵심 화면 6가지입니다. *추천 → 시청 연결 → 소셜*로 이어지는 흐름을 보여줍니다.

|  |  |
|:---:|:---:|
| <img src="docs/images/movie-detail.png" width="420"/> | <img src="docs/images/taste-map.png" width="420"/> |
| **🎬 영화 상세 — 추천에서 시청까지**<br/><sub>영화 정보·7종 평가·예고편과 함께, 그 자리에서 **OTT 보러가기** direct 링크로 바로 연결</sub> | **🗺️ 취향 유사도 맵**<br/><sub>장르 취향을 2D 평면에 배치해 **나와 가까운 유저**를 시각화 + 유사도 % 기반 친구 추천</sub> |
| <img src="docs/images/movie-battle.png" width="420"/> | <img src="docs/images/movie-throw.png" width="420"/> |
| **⚔️ 영화 배틀**<br/><sub>두 영화를 맞붙이는 투표 콘텐츠. 장르·감독·배우·태그·시대 기준으로 자동 생성</sub> | **🎯 영화 던지기**<br/><sub>상호 팔로우한 친구에게 영화를 "던져" 추천 — 추천·검색·내 목록에서 골라 전달</sub> |
| <img src="docs/images/badges.png" width="420"/> | <img src="docs/images/mypage-profile.png" width="420"/> |
| **🏅 뱃지 · 업적**<br/><sub>활동 기반 13종·4티어(브론즈·실버·골드·플래티넘). 보유 뱃지 중 대표 뱃지를 선택</sub> | **👤 마이페이지 · 프로필**<br/><sub>활동 요약·취향 도넛 차트·**구독 중인 OTT**·인생영화를 한곳에서 관리</sub> |
